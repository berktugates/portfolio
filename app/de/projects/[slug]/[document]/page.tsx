...
export function generateMetadata(props: Props) { return createProjectLegalMetadata("de", props); }
export default function Page(props: Props) { return <ProjectLegalPage locale="de" params={props.params} />; }
