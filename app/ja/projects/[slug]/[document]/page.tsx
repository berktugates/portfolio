...
export function generateMetadata(props: Props) { return createProjectLegalMetadata("ja", props); }
export default function Page(props: Props) { return <ProjectLegalPage locale="ja" params={props.params} />; }
