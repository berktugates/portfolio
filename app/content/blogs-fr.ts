...
"permission-models-for-multi-tenant-ai-copilots": {
    title: "Modèles de permissions pour copilotes IA multi-tenant",
    excerpt: "Un copilote IA multi-tenant qui hérite des permissions de chat mais ignore les ACL données citera avec assurance le mauvais tenant. Les appels d'outils doivent suivre le même chemin d'autorisation que vos API—scoped par tenant, rôle et ressource.",
    description: "Modèles de permissions staff pour copilotes IA multi-tenant : isolation tenant, authz au niveau outil, filtres de retrieval, credentials délégués et pistes d'audit qui survivent au fan-out d'agents.",
    sections: [
      {
        heading: "L'accès chat n'est pas l'accès données",
        paragraphs: [
      ...
      {
        heading: "Autoriser les outils comme des API publiques",
        paragraphs: [
      ...
      {
        heading: "Modéliser le principal pour lequel l'agent agit",
        paragraphs: [
      ...
      {
        heading: "Prouver l'isolation en continu",
        paragraphs: [
...
"progressive-delivery-for-multi-tenant-saas": {
    ...
    description: "Comment les staff engineers mènent la progressive delivery en SaaS multi-tenant : cohortes de tenants, ring deployments, exposition par flags, rollback par tenant et métriques guardrail qui respectent l'isolation.",
    sections: [
      {
        heading: "Les tenants ne sont pas des canaries interchangeables",
        paragraphs: [
      ...
      {
        heading: "Séparer deploy et expose",
        paragraphs: [
      ...
      {
        heading: "Les guardrails doivent respecter l'isolation",
        paragraphs: [
      ...
      {
        heading: "Rendre la promotion ennuyeuse et réversible",
        paragraphs: [
...
"measuring-retrieval-quality-without-vanity-metrics": {
    title: "Mesurer la qualité de retrieval sans vanity metrics",
    excerpt: "La similarité d'embedding et le clic en démo ne prouvent pas que le retrieval aide les utilisateurs. Mesurez le succès de tâche, les taux de réponses ancrées et les hard negatives qui ne doivent rien renvoyer.",
    description: "Playbook staff pour la qualité de retrieval : labels offline, métriques de tâche online, abstention correcte, evals par tranche et éviter les dashboards RAG de vanité.",
    sections: [
      {
        heading: "La similarité n'est pas l'utilité",
        paragraphs: [
      ...
      {
        heading: "Construisez un jeu d'évaluation qui peut vous faire échouer",
        paragraphs: [
      ...
      {
        heading: "Les métriques online doivent se lier aux outcomes",
        paragraphs: [
      ...
      {
        heading: "Opérer le retrieval comme une dépendance de production",
        paragraphs: [
...
"ownership-models-for-shared-platform-code": {
    title: "Modèles d'ownership pour le code plateforme partagé",
    excerpt: "Les libraries partagées sans owners clairs deviennent la dépendance de tous et l'incident de personne. Choisissez un modèle d'ownership aligné sur le blast radius, le rythme de change et qui est pagé.",
    description: "Guidance staff sur l'ownership du code plateforme partagé : CODEOWNERS, équipes plateforme vs mainteneurs fédérés, stabilité d'interface et exploitation sans risque orphelin.",
    sections: [
      {
        heading: "Partagé veut dire accountable, pas anonyme",
        paragraphs: [
      ...
      {
        heading: "Choisissez un modèle qui colle au blast radius",
        paragraphs: [
      ...
      {
        heading: "Les interfaces sont le produit du code plateforme",
        paragraphs: [
      ...
      {
        heading: "Rendre l'ownership visible dans le chemin de livraison",
        paragraphs: [
...
"designing-kill-switches-for-ai-features": {
    title: "Concevoir des kill switches pour les fonctionnalités IA",
    excerpt: "Si vous ne pouvez pas désactiver une capacité IA en quelques minutes sans faire tomber le produit, vous n'êtes pas prêt pour des actions irréversibles.",
    description: "Kill switches pour features IA : portées de blast radius, soft degrade vs hard stop, SLA de propagation, tripwires et fallbacks utilisateur qui préservent le travail critique.",
    sections: [
      {
        heading: "Un flag n'est un kill switch que lorsqu'il arrête le blast radius",
        paragraphs: [
      ...
      {
        heading: "Porter par risque, pas par granularité de vanité",
        paragraphs: [
      ...
      {
        heading: "Tester le dark path comme une porte de release",
        paragraphs: [
      ...
      {
        heading: "Communiquer la panne comme produit, pas comme spam d'excuses",
        paragraphs: [
