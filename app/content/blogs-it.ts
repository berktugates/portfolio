...
"offline-first-sync-conflicts-in-mobile-apps": {
    ...
    description: "Come gli staff engineer progettano la sync offline-first mobile: tipi di conflitto, CRDT vs last-write-wins, mutazioni idempotenti, UX di merge e telemetria che prova la salute sync sul campo.",
    sections: [
      {
...
"feature-store-vs-prompt-store-tradeoffs": {
    title: "Feature store vs prompt store: compromessi",
    excerpt: "I feature store ottimizzano segnali deterministici per i modelli; i prompt store ottimizzano linguaggio, tool e policy per gli LLM. Confonderli crea doppia verità e contesto stantio.",
    description: "Compromessi staff tra feature store e prompt store per prodotti IA: SLA di freschezza, ownership, versionamento, parità offline/online e quando unificare il retrieval invece di duplicare i registry.",
    sections: [
      {
        heading: "Risolgono problemi di freschezza diversi",
        paragraphs: [
      ...
      {
        heading: "Quando un feature store vale la pena",
        paragraphs: [
      ...
      {
        heading: "Quando un prompt store è l'astrazione giusta",
        paragraphs: [
      ...
      {
        heading: "Unificare il retrieval, non duplicare la verità",
        paragraphs: [
...
"contract-testing-for-ai-tool-calling": {
    title: "Contract testing per il tool calling IA",
    excerpt: "Quando il modello inventa argomenti o salta campi obbligatori, i unit test sul prompt non bastano. I contract test trasformano gli schemi tool in confini vincolanti tra modello e sistemi.",
    description: "Come gli staff engineer applicano il contract testing al tool calling IA: fixture di schema, coppie golden request/response, check di drift del provider e gate CI che intercettano invocazioni non sicure prima della produzione.",
    sections: [
      {
        heading: "Trattare gli schemi tool come API di prodotto",
        paragraphs: [
      ...
      {
        heading: "Testare il confine, non la poesia",
        paragraphs: [
      ...
      {
        heading: "Rendere il drift visibile nei gate di release",
        paragraphs: [
      ...
      {
        heading: "Recuperare come prodotto, non come parser",
        paragraphs: [
...
"measuring-retrieval-quality-without-vanity-metrics": {
    ...
    description: "Playbook staff per la qualità del retrieval: label offline, metriche di task online, abstention corretta, eval a slice ed evitare dashboard RAG di vanità.",
    sections: [
      {
        heading: "La similarità non è utilità",
        paragraphs: [
      ...
      {
        heading: "Costruite un set di valutazione che possa farvi fallire",
        paragraphs: [
      ...
      {
        heading: "Le metriche online devono collegarsi agli outcome",
        paragraphs: [
      ...
      {
        heading: "Operare il retrieval come una dipendenza di produzione",
        paragraphs: [
...
"mobile-background-work-that-survives-os-limits": {
    ...
    description: "Pattern staff per lavoro in background mobile sotto i limiti iOS e Android: WorkManager e BGTaskScheduler, sync vincolata, wakeup push e code offline resilienti.",
    sections: [
      {
        heading: "L'OS possiede l'orologio, non il vostro processo",
        paragraphs: [
      ...
      {
        heading: "Accodare in locale, riconciliare da remoto",
        paragraphs: [
      ...
      {
        heading: "Push e brevi wakeup sono feature, non trucchi",
        paragraphs: [
      ...
      {
        heading: "Misurate il completamento, non solo l'enqueue",
        paragraphs: [
...
"release-trains-for-ai-assisted-products": {
    ...
    description: "Come gli staff engineer progettano release train per prodotti assistiti dall'IA: cadenza fissa, gate di valutazione, versioning di modello e prompt, kill switch e coordinamento tra product e platform.",
    sections: [
      {
        heading: "Il cambio settimanale del modello non è un processo di release",
        paragraphs: [
      ...
      {
        heading: "Versionate insieme le tre superfici",
        paragraphs: [
      ...
      {
        heading: "I gate devono riflettere il rischio di prodotto, non il polish della demo",
        paragraphs: [
      ...
      {
        heading: "Coordinate le persone intorno alla cadenza",
        paragraphs: [
  ...
  "ai-crawler-control-is-now-web-infrastructure": {
    title: "Il controllo dei crawler AI è diventato infrastruttura web",
    excerpt: "La policy dei crawler AI è passata da una nota in robots.txt a un piano di controllo di produzione per visibilità, costi, licenze e fiducia.",
    description: "Come gestire l’accesso dei crawler AI con robots.txt, segnali llms.txt, enforcement edge, log e compromessi SEO misurabili.",
    sections: [
      { heading: "La policy dei crawler è una decisione di prodotto", paragraphs: ["I crawler AI hanno trasformato un file infrastrutturale silenzioso in una decisione centrale di publishing. Indicizzazione, training di modelli, retrieval, motori di risposta, bot di archivio e scraper abusivi possono apparire simili su HTTP ma avere conseguenze diverse.", "La scelta di produzione non è solo permettere o bloccare. Una policy utile separa ricerca per utenti, training AI commerciale, retrieval con citazione, integrazioni partner e scraping ostile."] },
      { heading: "robots.txt è un segnale, non tutto il controllo", paragraphs: ["robots.txt resta il posto più semplice per pubblicare l’intento, e i crawler corretti lo leggono. Non è però autenticazione, registro contrattuale, rate limiter o rilevatore di abuso.", "Servono quindi controlli edge: classificare richieste, limitare percorsi costosi, bloccare classi indesiderate e registrare identità del bot, percorso, cache e dimensione della risposta."], points: ["Mantenere robots.txt semplice, esplicito e revisionato", "Usare llms.txt come guida leggibile dalle macchine, non come enforcement", "Applicare le regole critiche a edge o applicazione", "Misurare separatamente costo di crawl, valore referral e valore citation"] },
      { heading: "Visibilità e protezione vanno misurate insieme", paragraphs: ["Bloccare tutto sembra sicuro, ma può ridurre la scoperta legittima. Consentire tutto sembra orientato alla crescita, ma può sovvenzionare prodotti che estraggono valore senza rimandare utenti.", "Misurate il traffico crawler contro risultati concreti: pagine indicizzate, impression, sessioni referral, costo server, cache hit ratio, conversioni e repliche non autorizzate."] },
      { heading: "Costruire la policy come infrastruttura di produzione", paragraphs: ["Una configurazione solida parte dall’inventario: classi di crawler osservate, contenuti toccati, valore utente creato, costo o rischio introdotto.", "Codificate la policy in regole versionate, aggiungete test ai percorsi critici e includete il comportamento dei crawler nelle review di release delle nuove sezioni."] },
      { heading: "Il modello operativo", paragraphs: ["Gestite la governance dei crawler come ciclo mensile: rivedere log, aggiornare categorie bot, confrontare Search Console con crawl server-side e verificare attribution dei nuovi referrer AI.", "La postura vincente è apertura disciplinata: rendere i contenuti pubblici di qualità facili da scoprire, citare e condividere; rendere costosa l’estrazione senza attribution."] },
      { heading: "Fonti primarie e letture", paragraphs: ["Le raccomandazioni combinano pratica degli standard web e documentazione corrente sul controllo dei crawler."], links: [{ label: "Cloudflare Docs — AI crawler and bot traffic controls", url: "https://developers.cloudflare.com/bots/concepts/bot/ai-crawlers/" }, { label: "Cloudflare Docs — Managed robots.txt", url: "https://developers.cloudflare.com/bots/additional-configurations/managed-robots-txt/" }, { label: "IETF — The Robots Exclusion Protocol", url: "https://www.rfc-editor.org/rfc/rfc9309" }, { label: "llms.txt proposal", url: "https://llmstxt.org/" }, { label: "Google Search Central — robots.txt introduction", url: "https://developers.google.com/search/docs/crawling-indexing/robots/intro" }] },
    ],
  },
