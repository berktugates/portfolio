...
export const metadata: Metadata = {
  ...
  robots: { index: true, follow: true, googleBot: { index: true, follow: true, "max-image-preview": "large", "max-snippet": -1, "max-video-preview": -1 } }, icons: { icon: "/me.ico", apple: "/me.png" }, category: "technology",
};
