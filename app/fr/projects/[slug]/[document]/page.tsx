...
export function generateMetadata(props: Props) { return createProjectLegalMetadata("fr", props); }
export default function Page(props: Props) { return <ProjectLegalPage locale="fr" params={props.params} />; }
