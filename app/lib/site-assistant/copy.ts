...
const de: SiteAssistantCopy = {
  ...
  emptyHint: "Wählen Sie eine Frage oder beschreiben Sie Ihr Projekt.",
...
const fr: SiteAssistantCopy = {
  ...
  emptyHint: "Choisissez une question ou décrivez votre projet.",
...
const it: SiteAssistantCopy = {
  ...
  emptyHint: "Scegli una domanda o descrivi il progetto.",
...
const ja: SiteAssistantCopy = {
  ...
  emptyHint: "下の質問を選ぶか、プロジェクトを書いてください。",
