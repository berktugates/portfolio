...
export function generateMetadata(props: Props) { return createProjectLegalMetadata("it", props); }
export default function Page(props: Props) { return <ProjectLegalPage locale="it" params={props.params} />; }
